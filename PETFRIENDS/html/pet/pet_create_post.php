...
if(!isset($_SESSION["error_img"])){	//la primera vez que entra al sitio pasa por aqui.
		$_SESSION["error_img"]="0";
}
if($_SESSION["error_img"] == "1"){	//si la validacion no encontro coincidencias activa la alerta
echo '	<div class="alert alert-danger">
		<strong>Error!</strong> El Formato de la Imagen no es correcto.
		</div>';
$_SESSION["error_img"] = 0;}
?>
<html>
	...
	<article class="bg-article col-md-12 row equal">
		...
		<div class="col-md-6" style="background-color:white;padding:0px;">
			...
			<?php 
				...
				echo'
				<li role="presentation"><a href="','/PETFRIENDS/html/pet/pet_wall.php?pet_name=',$pet_name,'&user_pet_id='.$user.'">Muro</a></li>
				<li role="presentation" class="active"><a href="#">Crear POST</a></li>
				<li role="presentation"><a href="','/PETFRIENDS/html/pet/perfil_pet.php?pet_name=',$pet_name,'&user_pet_id='.$user.'">Perfil Mascota</a></li>';
			?>
			</ul>
			<div class="col-md-12" style="border-style:solid;border-top:1px;border-color:#CCCCCC;border-width:1px;padding-top:20px;">
				<div class="col-md-12">
					<form method="post" enctype="multipart/form-data" action="/PETFRIENDS/includes/create_post.php?pet_name=<?php $pet = $_GET['pet_name'];echo $pet;?>">
					<div class="form-group col-md-12">
						<label for="create_post">POST:</label>
						<textarea class="form-control textarea" rows="10" id="create_post" name="texto_post"></textarea>
					</div>
					<div class="form-group col-md-12">
						<label for="imagen_post">Agregar Foto:</label>
						<input type="file" id="imagen_post" name="imagen_post">
