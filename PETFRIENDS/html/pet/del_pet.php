	...
	<article class="bg-article col-md-12 row equal">
		...
		<div class="col-md-6" style="background-color:white;padding:0px;">
			<ul class="nav nav-tabs nav-justified">
				...
				<li role="presentation"><a href="add_pet.php">Agregar Mascota</a></li>
				<li role="presentation" class="active"><a href="#">Eliminar Mascota</a></li>
			</ul>
			<div class="col-md-12" style="border-style:solid;border-top:1px;border-color:#CCCCCC;border-width:1px;padding-top:20px;">
				<form method="post" action="../../includes/delete_pet.php">	
					<div class="form-group col-md-12">
						<label for="del_pet">Mascota:</label>
						<select id="del_pet" name="del_pet" class="form-control">
							<?php require $raiz.'/PETFRIENDS/includes/form_del_pet.php';?>
						</select>
					</div>	
					<div class="form-group col-md-12">
						<p class="help-block">Tenga en Cuenta que si borra una mascota se perderan todos los datos.</p>
						<button type="submit" class="btn btn-default" name="delete">Eliminar Mascota</button>
					</div>
				</form>
			</div>
