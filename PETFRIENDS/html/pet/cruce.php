	...
	<article class="bg-article col-md-12 row equal">
		...
		<div class="col-md-6" style="background-color:white;padding:0px;">
			<ul class="nav nav-tabs nav-justified">
				<li role="presentation" class="active"><a href="#"><h3>Cruce de Mascotas</h3></a></li>
			</ul>
			<div class="col-md-12" style="border-style:solid;border-top:1px;border-color:#CCCCCC;border-width:1px;padding-top:20px;">
					<p>En esta seccion encontrara todas las mascotas de la comunidad que se encuentran disponibles para realizar cruce de razas con otras mascotas.</p>
				
					<?php require $raiz.'/PETFRIENDS/includes/cruce_info.php';?>			
			</div>
