	...
	<article class="bg-article col-md-12 row equal">
		...
		<div class="col-md-6" style="background-color:white;padding:0px;">
			<ul class="nav nav-tabs nav-justified">
				<li role="presentation" class="active"><a href="#"><h3>Mascotas Perdidas</h3></a></li>
			</ul>
			<div class="col-md-12" style="border-style:solid;border-top:1px;border-color:#CCCCCC;border-width:1px;padding-top:20px;">
					<p>En esta seccion encontrara todas las mascotas de la comunidad que se han perdido. Puede descargar el archivo PDF que contiene toda la informacion de la mascota junto con un codigo QR que le facilitara a las personas contactarse con el dueño de la mascota</p>
					<?php require $raiz.'/PETFRIENDS/includes/perdida_info.php';?>			
			</div>
