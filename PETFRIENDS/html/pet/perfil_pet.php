...
<ul class="dropdown-menu">
	...
	<article class="bg-article col-md-12 row equal">
		...
		<?php require $raiz.'/PETFRIENDS/includes/pet_data_perfil.php';?>
		<script src="/PETFRIENDS/js/Highcharts-5.0.12/code/highcharts.js"></script>
		<script src="/PETFRIENDS/js/Highcharts-5.0.12/code/modules/exporting.js"></script>
		<?php require $raiz.'/PETFRIENDS/includes/ranking_siempre.php';?>
		<?php require $raiz.'/PETFRIENDS/includes/ranking_dia.php';?>
		<?php require $raiz.'/PETFRIENDS/includes/ranking_semana.php';?>
