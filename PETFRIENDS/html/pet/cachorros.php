	...
	<article class="bg-article col-md-12 row equal">
		...
		<div class="col-md-6" style="background-color:white;padding:0px;">
			<ul class="nav nav-tabs nav-justified">
				<li role="presentation" class="active"><a href="#"><h3>Cachorros en Adopcion</h3></a></li>
			</ul>
			<div class="col-md-12" style="border-style:solid;border-top:1px;border-color:#CCCCCC;border-width:1px;padding-top:20px;">
					<p>En esta seccion encontrara todos los cachorros de la comunidad que se encuentran en situacion de ser adoptadas.</p>
				
					<?php require $raiz.'/PETFRIENDS/includes/cachorros_info.php';?>			
			</div>
