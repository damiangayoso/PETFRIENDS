...
<script type="text/javascript" language="javascript">
	function emergente(url) {
		window.open(url,"Editar","width=400,height=550,top=80,left=400,toolbar=no,location=no,status=no,menubar=no,directories=no")
	}

</script>
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBBzTwyvY3sA3gqOSneLYEkXvjMQ__IVCc"></script>
	...
	<article class="bg-article col-md-12 row equal">
		...
		<div class="col-md-6" style="background-color:white;padding:0px;">
			<ul class="nav nav-tabs nav-justified">
				<li role="presentation" class="active"><a href="#">USUARIO</a></li>
				<li role="presentation"><a href="../pet/add_pet.php">Agregar Mascota</a></li>
				<li role="presentation"><a href="../pet/del_pet.php">Eliminar Mascota</a></li>
			</ul>
			<div class="col-md-12" style="border-style:solid;border-top:1px;border-color:#CCCCCC;border-width:1px;padding-top:20px;">
				<?php require $raiz.'/PETFRIENDS/includes/user_data_perfil.php';?>
				<?php require $raiz.'/PETFRIENDS/includes/geo.php';?>
			</div>
