<?php
	...
	$query_post = "	SELECT *
							...
							WHERE pdb.post_petId IN	(SELECT contacts.contact_petB
													...
													WHERE contacts.contact_userA = '$user')
	...
	echo '		<ul class="nav nav-tabs nav-justified">
					...
					<li role="presentation"><a href="','/PETFRIENDS/html/pet/pet_create_post.php?pet_name=',$pet_nombre,'&user_pet_id='.$user.'">Crear POST</a></li>
					<li role="presentation"><a href="','/PETFRIENDS/html/pet/perfil_pet.php?pet_name=',$pet_nombre,'&user_pet_id='.$user.'">Perfil Mascota</a></li>
				</ul>
	...
	echo '	<div class="col-md-12" style="background-color:#EEEEEE;padding:1px;" align="right">
						<h4 style="height:3px;">',$comment["user_firstName"],'</h4>
